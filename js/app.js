...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product bg-card-color m-3 text-white rounded p-4
    ">                  
                        <div>
                          <img class="product-image m-3" src=${image}></img> 
                        </div>
                        <h3>${product.title}</h3>
                        ...
                        <h2 class="text-dark">Price: $ ${product.price}</h2>
                        ...
                        <button id="details-btn" class="btn btn-dark text-white fw-bold">Details</button>
                     </div>
      `;
